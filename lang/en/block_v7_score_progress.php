...
/**
 * Strings for component 'block_v7_score_progress', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['configtitle'] = 'Score Progress';
$string['v7_score_progress:addinstance'] = 'Score Progress';
$string['v7_score_progress:myaddinstance'] = 'Add a new HTML block to Dashboard';
$string['newv7scoreprogressblock'] = 'Score Progress';
$string['pluginname'] = 'V7 Score Progress';
$string['search:content'] = 'Score Progress block content';
